...
access_plugin=$plugin}
 <div class="mTop15 mBottom15">
  ...
  {capture name='grn_pageurl_command_send_path'}{grn_pageurl page=workflow/command_`$page_info.last`}{/capture}
  {strip}
   {grn_button id=`$page_info.last`_submit_back_to_prev spacing='tight' caption=$smarty.capture.grn_workflow_back_to_prev_screen
   onclick="document.forms['$form_name'].cmd.value='back'; grn.page.workflow.ajax_submit.workflow_submit('$form_name', '`$smarty.capture.grn_pageurl_command_send_path`', this);"}
   {grn_button id=`$page_info.last`_submit_confirm_contents ui='main' spacing='loose' caption=$smarty.capture.grn_workflow_confirm_contents_2
   onclick="document.forms['$form_name'].cmd.value='send'; grn.component.member_add.get_instance('route_member_add').prepareSubmit(); grn.page.workflow.ajax_submit.workflow_submit('$form_name', '`$smarty.capture.grn_pageurl_command_send_path`', this);"}
   {grn_button id='workflow_button_cancel' action='cancel' onclick="document.forms['$form_name'].cmd.value='cancel'; grn.page.workflow.ajax_submit.workflow_submit('$form_name', '`$smarty.capture.grn_pageurl_command_send_path`', this);"}
  {/strip}
 </div>
