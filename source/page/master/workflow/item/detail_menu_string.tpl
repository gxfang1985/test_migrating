...
<table class="view_table">
 ...
 <tr valign="top">
  <th>{cb_msg module='grn.workflow' key='menu_item' replace='true'}</th>
  {if $item.settings.menu_item_type == 1}
  <td>{cb_msg module='grn.workflow' key='member_group' replace='true'}</td>
  {else}
 ...
 <tr valign="top">
  ...
  {if $item.settings.menu_item_type == 1}
  <td>{cb_msg module='grn.workflow' key='priority_group' replace='true'}</td>
  {else}
