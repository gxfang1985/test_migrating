...
{if $display == 'add-system' || $display == 'modify-system'}
<form name="{$form_name}" method="post" action="{grn_pageurl page='workflow/system/item/command_set_radio'}" enctype="multipart/form-data">
    {else}
<form name="{$form_name}" method="post" action="{grn_pageurl page='workflow/item/command_set_radio'}" enctype="multipart/form-data">
{/if}
...
<table class="std_form">
 ...
 <tr valign="top">
  <th nowrap>{capture name='grn_workflow_radio_item'}{cb_msg module='grn.workflow' key='radio_item' replace='true'}{/capture}{grn_show_input_title title=$smarty.capture.grn_workflow_radio_item}<span class='attention' id='account' style="display:none">*</span></th>
  <td>
