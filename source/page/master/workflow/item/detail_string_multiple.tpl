...
<table class="view_table">
 ...
 <tr valign="top">
  <th>{cb_msg module='grn.workflow' key='size' replace='true'}</th>
  <td>{$item.settings.col_size|escape}{cb_msg module='grn.workflow' key='key_30_1' replace='true'}{$item.settings.row_size|escape}{cb_msg module='grn.workflow' key='key_30_2' replace='true'}</td>
 </tr>
 <tr valign="top">
