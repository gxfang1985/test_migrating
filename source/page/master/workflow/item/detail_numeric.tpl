...
<table class="view_table">
 ...
 <tr valign="top">
  <th>{cb_msg module='grn.workflow' key='entry_limit' replace='true'}</th>
  <td>
      {if $item.settings.input_numbers == 0}
        {cb_msg module='grn.workflow' key='unlimited_none' replace='true'}
      {else}
        {cb_msg module='grn.workflow' key='key_44_1' replace='true'}{$item.settings.max_input_number|escape}{cb_msg module='grn.workflow' key='key_44_2' replace='true'}{$item.settings.min_input_number|escape}{cb_msg module='grn.workflow' key='key_44_3' replace='true'}
      {/if}
  </td>
 </tr>
 <tr valign="top">
...
{include file='workflow/item/_detail_item_condition.tpl' required_item=true}
 <tr valign="top">
  ...
  <td>
      {if $item.settings.right_align == 1}{cb_msg module='grn.workflow' key='align_right' replace='true'}{/if}
