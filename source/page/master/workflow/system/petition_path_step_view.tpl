...
{foreach name=user from=$path_step.users item=user}
   <span class="voice">{grn_user_name uid=$user._id name=$user.col_display_name  valid=$user.col_valid}</span><br>
{/foreach}
{/if}
  </td>
 </tr>
