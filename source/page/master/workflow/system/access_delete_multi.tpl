...
{cb_msg module='grn.workflow.system' key='key_132_1' replace='true'}<span class="bold">{grn_sentence image='category20.gif' caption=$node.name}</span>{cb_msg module='grn.workflow.system' key='key_132_2' replace='true'}{cb_msg module='grn.workflow.system' key='key_132_3' replace='true'}<span class="bold">{$count|escape}</span>{cb_msg module='grn.workflow.system' key='key_132_4' replace='true'}
</div>
