...
<form name="{$form_name}" method="post" action="{grn_pageurl page='workflow/system/command_'|cat:$page_info.last postfix=$filename postfix='form.xml'}"><input type="hidden" name="csrf_ticket" value="{$csrf_ticket}">
...
<p>
 ...
 {capture name='grn_workflow_system_w_cancel'}{cb_msg module='grn.workflow.system' key='w_cancel' replace='true'}{/capture}{grn_button_cancel caption=$smarty.capture.grn_workflow_system_w_cancel page='workflow/system/form_list' cid=$category.cid}
</p>
