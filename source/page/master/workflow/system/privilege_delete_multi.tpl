...
{cb_msg module='grn.workflow.system' key='key_169_1' replace='true'}<span class="bold">{grn_sentence image='category20.gif' caption=$node.name}</span>{cb_msg module='grn.workflow.system' key='key_169_2' replace='true'}<span class="bold">{$count|escape}</span>{cb_msg module='grn.workflow.system' key='key_169_3' replace='true'}
</div>
