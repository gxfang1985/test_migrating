...
<table class="std_form">
 ...
 <tr>
  <td></td>
  <td>
      {capture name='grn_workflow_system_w_do_add_y'}{cb_msg module='grn.workflow.system' key='w_do_add_y' replace='true'}{/capture}{grn_button_submit class='margin' caption=$smarty.capture.grn_workflow_system_w_do_add_y id="`$page_info.all`_submit"}
