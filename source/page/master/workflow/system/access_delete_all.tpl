...
{cb_msg module='grn.workflow.system' key='key_135_1' replace='true'}<span class="bold">{grn_image image='category20.gif'}{$node.name|escape}</span>{cb_msg module='grn.workflow.system' key='key_135_2' replace='true'}
</div>
