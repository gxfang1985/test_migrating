...
{capture name='grn_workflow_system_w_do_add_y'}{cb_msg module='grn.workflow.system' key='w_do_add_y' replace='true'}{/capture}{include file='workflow/system/_path_condition_add.tpl' btn_name=$smarty.capture.grn_workflow_system_w_do_add_y}
</form>
