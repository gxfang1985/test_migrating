...
<table class="std_form">
 ...
 <tr>
  <th nowrap>{capture name='grn_workflow_system_w_new_application_approved_number_y'}{cb_msg module='grn.workflow.system' key='GRN_WKF_SYS-123' replace='true'}{/capture}{grn_show_input_title title=$smarty.capture.grn_workflow_system_w_new_application_approved_number_y necessary='1'}</th>
  <td>
