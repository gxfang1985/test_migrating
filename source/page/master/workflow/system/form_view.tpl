...
{if GRN_WORKFLOW_PRIVATE_PATH == $path.col_type}
 <span class="menu_item">{capture name='grn_workflow_system_w_do_change_y'}{cb_msg module='grn.workflow.system' key='w_do_change_with_no_cancel_y' replace='true'}{/capture}{grn_link caption=$smarty.capture.grn_workflow_system_w_do_change_y page=workflow/system/form_path_modify cid=$category_id fid=$form_id pid=$pid image='modify20.gif' element_id="workflow/system/form_path_modify"}</span>
 <span class="menu_item">{capture name='grn_workflow_system_w_share_pathway'}{cb_msg module='grn.workflow.system' key='w_share_pathway' replace='true'}{/capture}{grn_link caption=$smarty.capture.grn_workflow_system_w_share_pathway page=workflow/system/form_path_publish cid=$category_id fid=$form_id image='open20.gif' element_id="workflow/system/form_path_publish"}</span>
{else}
 <span class="menu_item">{capture name='grn_workflow_system_w_do_set_private_route_y'}{cb_msg module='grn.workflow.system' key='w_do_set_private_route_y' replace='true'}{/capture}{grn_link caption=$smarty.capture.grn_workflow_system_w_do_set_private_route_y page=workflow/system/form_path_add cid=$category_id fid=$form_id image='private_path20.gif' element_id="workflow/system/form_path_add"}</span>
{/if}
 <span class="menu_item">{capture name='grn_workflow_system_w_set_shared_pathway'}{cb_msg module='grn.workflow.system' key='w_set_shared_pathway' replace='true'}{/capture}{grn_link caption=$smarty.capture.grn_workflow_system_w_set_shared_pathway page=workflow/system/form_path_select cid=$category_id fid=$form_id image='public_path20.gif' disabled=$no_public_path element_id="workflow/system/form_path_select"}</span>
 <span class="menu_item">{capture name='grn_workflow_system_w_pathway_preview'}{cb_msg module='grn.workflow.system' key='w_pathway_preview' replace='true'}{/capture}{grn_link caption=$smarty.capture.grn_workflow_system_w_pathway_preview page=workflow/system/form_path_preview_select cid=$category_id fid=$form_id pid=$pid image='path20.gif' disabled=$no_path_step element_id="workflow/system/form_path_preview_select"}</span>
</div>
...
{if GRN_WORKFLOW_PRIVATE_PATH == $path.col_type}
<p>
<form name="{$form_name}/acceptance_path" method="post" action="{grn_pageurl page='workflow/system/form_path_step_delete_multi'}"><input type="hidden" name="csrf_ticket" value="{$csrf_ticket}">
<input type="hidden" name="cid" value="{$category_id|escape}">
<input type="hidden" name="fid" value="{$form_id|escape}">
<div class="sub_title">{cb_msg module='grn.workflow.system' key='w_approve_route_y' replace='true'}</div>
<div id="main_menu_part">
 <span class="menu_item">{capture name='grn_workflow_system_w_do_add_y'}{cb_msg module='grn.workflow.system' key='w_do_add_y' replace='true'}{/capture}{grn_link caption=$smarty.capture.grn_workflow_system_w_do_add_y page=workflow/system/form_path_step_add cid=$category_id fid=$form_id image='write20.gif' element_id="workflow/system/form_path_step_add"}</span>
 <span class="menu_item">{capture name='grn_workflow_system_w_do_change_order_y'}{cb_msg module='grn.workflow.system' key='w_do_change_order_y' replace='true'}{/capture}{grn_link caption=$smarty.capture.grn_workflow_system_w_do_change_order_y page=workflow/system/form_path_step_order cid=$category_id fid=$form_id image='order20.gif' disabled=$no_acceptance_path_step element_id="workflow/system/form_path_step_order"}</span>
</div>
...
{/if}
  ...
  <td nowrap>
   {grn_link caption=$path_step.col_role page='workflow/system/form_path_step_view' cid=$category_id fid=$form_id psid=$path_step._id}
  </td>
...
<p>
<form name="{$form_name}/circular_path" method="post" action="{grn_pageurl page='workflow/system/form_path_step_delete_multi'}"><input type="hidden" name="csrf_ticket" value="{$csrf_ticket}">
<input type="hidden" name="cid" value="{$category_id|escape}">
<input type="hidden" name="fid" value="{$form_id|escape}">
<div class="sub_title">{cb_msg module='grn.workflow.system' key='w_circular_pathway' replace='true'}</div>
<div id="main_menu_part">
 <span class="menu_item">{capture name='grn_workflow_system_w_do_add_y'}{cb_msg module='grn.workflow.system' key='w_do_add_y' replace='true'}{/capture}{grn_link caption=$smarty.capture.grn_workflow_system_w_do_add_y page=workflow/system/form_path_step_add  cid=$category_id fid=$form_id col_type=1 image='write20.gif' element_id="workflow/system/form_path_step_add/type_1"}</span>
 <span class="menu_item">{capture name='grn_workflow_system_w_do_change_order_y'}{cb_msg module='grn.workflow.system' key='w_do_change_order_y' replace='true'}{/capture}{grn_link caption=$smarty.capture.grn_workflow_system_w_do_change_order_y page=workflow/system/form_path_step_order cid=$category_id fid=$form_id col_type=1 image='order20.gif' disabled=$no_circular_path_step element_id="workflow/system/form_path_step_order/type_1"}</span>
</div>
<table class="list_column" width="80%" border="1" cellspacing="0" cellpadding="2">
 <colgroup>
     <col width="1%">
...
<p>
{if 0 >= $path_skip_item_total || $path_skip}
{assign var='already_set' value=true}
{/if}
{if ! $path_skip_item.display_type}
...
<p>
<form name="{$form_name}/pathcondition" method="post" action="{grn_pageurl page='workflow/system/path_condition_delete_multi'}"><input type="hidden" name="csrf_ticket" value="{$csrf_ticket}">
...
<div id="main_menu_part">
 <span class="menu_item">{capture name='grn_workflow_system_w_do_add_y'}{cb_msg module='grn.workflow.system' key='w_do_add_y' replace='true'}{/capture}{grn_link caption=$smarty.capture.grn_workflow_system_w_do_add_y page='workflow/system/path_condition_add' cid=$category_id fid=$form_id sid=$path_skip._id image='write20.gif' disabled=$no_path_condition}</span>
 <span class="menu_item">{if $condition_list_count <= 1}{assign var='condition_order_disabled' value='true'}{/if}{capture name='grn_workflow_system_w_do_change_order_y'}{cb_msg module='grn.workflow.system' key='w_do_change_order_y' replace='true'}{/capture}{grn_link caption=$smarty.capture.grn_workflow_system_w_do_change_order_y page=workflow/system/path_condition_order cid=$category_id fid=$form_id sid=$path_skip._id image='order20.gif' disabled=$condition_order_disabled}</span>
</div>
  <table class="list_column" width="80%" border="1" cellspacing="0" cellpadding="2">
    <colgroup>
     <col width="1%">
  ...
  <th>{include file='workflow/checkall.tpl' func_name="CheckAllPathConditions" form_name="`$form_name`/pathcondition" elem_name='pcids[]'}</th>
 </th>
...
<tr>
 <td nowrap>
  {grn_checkbox name='pcids[]' id="pcids`$condition._id`" value=$condition._id caption=''}</td>
 <td nowrap>{grn_link caption=$condition.col_name page='workflow/system/path_condition_view' cid=$category_id fid=$form_id sid=$path_skip._id pcid=$condition._id}</td>
...
<div class="marginHalf">
{cb_msg module='grn.workflow.system' key='w_delete_checked_item_1' replace='true'}{capture name='grn_workflow_system_w_delete_checked_item_2'}{cb_msg module='grn.workflow.system' key='w_delete_checked_item_2' replace='true'}{/capture}{grn_button_submit caption=$smarty.capture.grn_workflow_system_w_delete_checked_item_2 onclick="if(!grn_is_checked(this.form,'pcids[]')) return false;"}{cb_msg module='grn.workflow.system' key='w_delete_checked_item_3' replace='true'}
</div>
</form>
</p>
  {/if}
