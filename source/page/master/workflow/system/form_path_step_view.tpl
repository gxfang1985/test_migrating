...
<div id="main_menu_part">
 <span class="menu_item">
  {capture name='grn_workflow_system_w_do_change_y'}{cb_msg module='grn.workflow.system' key='w_do_change_with_no_cancel_y' replace='true'}{/capture}{grn_link caption=$smarty.capture.grn_workflow_system_w_do_change_y page='workflow/system/form_path_step_modify' image='modify20.gif' cid=$cid fid=$fid psid=$psid}
 </span>
 <span class="menu_item">
  {capture name='grn_workflow_system_w_do_set_initial_value_y'}{cb_msg module='grn.workflow.system' key='w_do_set_initial_value_y' replace='true'}{/capture}{grn_link caption=$smarty.capture.grn_workflow_system_w_do_set_initial_value_y page='workflow/system/form_default_list' image='modify20.gif' cid=$cid fid=$fid psid=$psid}
 </span>
 <span class="menu_item">
  {capture name='grn_workflow_system_w_do_delete'}{cb_msg module='grn.workflow.system' key='w_do_delete' replace='true'}{/capture}{grn_link caption=$smarty.capture.grn_workflow_system_w_do_delete page='workflow/system/form_path_step_delete' image='delete20.gif' cid=$cid fid=$fid psid=$psid}
 </span>
</div>
<p></p>
{/if}
