...
<div id="workflow_item_access_list">
...
{foreach name=item_list from=$item_list item=item}
  <tr>
   ...
   <td>
     {capture name='grn_workflow_system_w_change_y'}{cb_msg module='grn.workflow.system' key='w_change_y' replace='true'}{/capture}{grn_link page='workflow/system/item_access_modify' caption=$smarty.capture.grn_workflow_system_w_change_y image='modify20.gif' cid=$cid fid=$item.form iid=$item.id}
   </td>
