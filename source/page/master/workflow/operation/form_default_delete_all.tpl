...
{cb_msg module='grn.workflow.system' key='key_118_1' replace='true'}<span class="bold">{$col_role|escape}</span>{cb_msg module='grn.workflow.system' key='key_118_2' replace='true'}
</div>
