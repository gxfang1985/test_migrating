...
{capture name="print_page_name"}{grn_appname app_id='workflow'} {cb_msg module='grn.workflow.operation' key='petition_print' replace='true'}{/capture}
...
<form name="{$form_name}" method="post" action="{grn_pageurl page='workflow/operation/petition_print'}"><input type="hidden" name="csrf_ticket" value="{$csrf_ticket}">
                            ...
                            <td nowrap>
                                {strip}
                                    <div class="mTop10 mBottom5">
                                        ...
                                        {grn_button id='' action="cancel" page='workflow/operation/petition_view' page_param_cid=$category_id page_param_fid=$form_id page_param_pid=$petition_id page_param_sf=1 caption=$smarty.capture.grn_workflow_system_w_back_y}
                                    </div>
                                {/strip}
                            </td>
                        </tr>
