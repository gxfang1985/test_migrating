...
<p class="explanation">{cb_msg module='grn.workflow.system' key='key_91_1' replace='true'}<span class="bold">{$col_role|escape}</span>{cb_msg module='grn.workflow.system' key='key_91_2' replace='true'}</p>
...
{capture name='grn_workflow_system_w_no'}{cb_msg module='grn.workflow.system' key='w_no' replace='true'}{/capture}{grn_button_cancel caption=$smarty.capture.grn_workflow_system_w_no page='workflow/operation/form_path_step_view' cid=$cid fid=$fid psid=$psid}
</form>
