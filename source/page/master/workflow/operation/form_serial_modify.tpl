...
<table class="std_form">
 ...
 <tr>
 <tr>
  <th nowrap>{capture name='grn_workflow_system_w_set_app_approved_no_format_y'}{cb_msg module='grn.workflow.system' key='GRN_WKF_SYS-133' replace='true'}{/capture}{grn_show_input_title title=$smarty.capture.grn_workflow_system_w_set_app_approved_no_format_y}</th>
  <td>
 ...
 <tr>
  <th nowrap>{capture name='grn_workflow_system_w_set_app_approved_no_form'}{cb_msg module='grn.workflow.system' key='GRN_WKF_SYS-134' replace='true'}{/capture}{grn_show_input_title title=$smarty.capture.grn_workflow_system_w_set_app_approved_no_form}</th>
  <td>
