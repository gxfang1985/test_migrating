...
<p class="explanation">{capture name='grn_workflow_system_w_description_y'}{cb_msg module='grn.workflow.system' key='w_description_y' replace='true'}{/capture}{cb_msg module='grn.workflow.system' key='w_enter_patheway_step_information' replace='true'}{grn_link caption="[`$smarty.capture.grn_workflow_system_w_description_y`]" page=workflow/operation/form_path_step_explain cid=$cid fid=$fid psid=$psid col_type=$col_type}</p>
...
{/if}
 ...
 <tr>
  <th nowrap>{capture name='grn_workflow_system_w_pathway_step_name'}{cb_msg module='grn.workflow.system' key='w_pathway_step_name' replace='true'}{/capture}{grn_show_input_title title=$smarty.capture.grn_workflow_system_w_pathway_step_name necessary=true}</th>
  <td>
 ...
 <tr>
  ...
  <td>
   {capture name='grn_workflow_system_w_permit_allow'}{cb_msg module='grn.workflow.system' key='w_permit_allow' replace='true'}{/capture}{grn_checkbox caption=$smarty.capture.grn_workflow_system_w_permit_allow name='col_change_path' id='col_skip' value='1' checked=$col_change_path}
  </td>
 </tr>
 <tr>
  <td></td>
  <td>
   ...
   {grn_button_cancel page='workflow/operation/form_path_step_view' cid=$cid fid=$fid psid=$psid}
  </td>
 </tr>
</table>
</form>
