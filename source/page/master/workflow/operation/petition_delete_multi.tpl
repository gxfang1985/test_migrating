...
{capture name=grn_workflow_system_key_106_order}{cb_msg module='grn.workflow.system' key='key_106_order' replace='true'}{/capture}
...
{foreach from=$petition_id_list item=id}
