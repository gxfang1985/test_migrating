...
{foreach from=$form_list item=form}
 {if $form.type == 0}
<nobr>
 {grn_workflow_link page='workflow/send_form' caption=$form.name truncated_caption=$config.subject_width icon_type=$form.icon_type icon_id=$form.icon_id icon_url=$form.icon_url cid=$category_id fid=$form.fid}
</nobr>
