...
<input type="hidden" name="bdate" value="{$bdate}">
 <p>{cb_msg module='grn.personal.calendar' key='GRN_PRS_CA-34' replace='true'}<br>
 {cb_msg module='grn.personal.calendar' key='GRN_PRS_CA-35' replace='true'}<span class="bold delete_count"></span><br>
 </p>
</form>
