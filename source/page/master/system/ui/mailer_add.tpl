...
<form name="{$form_name}" method="post" action="{grn_pageurl page='system/ui/command_mailer_add'}"><input type="hidden" name="csrf_ticket" value="{$csrf_ticket}">
...
<table class="std_form">
 ...
 <tr>
  <td></td>
  <td>
       {capture name='grn_system_ui_GRN_SY_UI_211'}{cb_msg module='grn.system.ui' key='GRN_SY_UI-211' replace='true'}{/capture}{grn_button_submit class="margin" caption=$smarty.capture.grn_system_ui_GRN_SY_UI_211}
       {grn_button_cancel page='system/ui/mailer_list'}
  </td>
 </tr>
</table>
