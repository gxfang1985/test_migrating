...
<form name="{$form_name}" method="post" action="{grn_pageurl page='system/application/command_'|cat:$page_info.last postfix='application_users.csv'}">
  ...
  <table class="std_form">
    ...
    <tr>
      ...
      <td>
        ...
        {grn_button_cancel page="system/common_list" id="application"}
      </td>
    </tr>
  </table>
  <hr>
