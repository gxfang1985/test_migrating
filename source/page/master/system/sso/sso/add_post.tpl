...
<form name="{$form_name}" method="post" action="{grn_pageurl page='system/sso/sso/command_add_post'}"><input type="hidden" name="csrf_ticket" value="{$csrf_ticket}">
...
<table class="std_form">
 <tr>
  <th nowrap>
      {capture name='grn_system_sso_sso_GRN_SY_SS_SS_69'}{cb_msg module='grn.system.sso.sso' key='GRN_SY_SS_SS-69' replace='true'}{/capture}{grn_show_input_title title=$smarty.capture.grn_system_sso_sso_GRN_SY_SS_SS_69 necessary=true}
  </th>
  <td>
       {capture name='grn_system_sso_sso_GRN_SY_SS_SS_70'}{cb_msg module='grn.system.sso.sso' key='GRN_SY_SS_SS-70' replace='true'}{/capture}{validate form=$form_name field="display_name" criteria="notEmpty" transform="cb_trim" message=$smarty.capture.grn_system_sso_sso_GRN_SY_SS_SS_70 append="validation_errors"}
       {grn_text name="display_name" class="display_name" necessary=true value="$display_name" size="50" disable_return_key=true}
  </td>
 </tr>
 <tr>
  <th nowrap>
      {capture name='grn_system_sso_sso_GRN_SY_SS_SS_71'}{cb_msg module='grn.system.sso.sso' key='GRN_SY_SS_SS-71' replace='true'}{/capture}{grn_show_input_title title=$smarty.capture.grn_system_sso_sso_GRN_SY_SS_SS_71 necessary=true}
  </th>
  <td>
       {capture name='grn_system_sso_sso_GRN_SY_SS_SS_72'}{cb_msg module='grn.system.sso.sso' key='GRN_SY_SS_SS-72' replace='true'}{/capture}{validate form=$form_name field="target_url" criteria="notEmpty" transform="cb_trim" message=$smarty.capture.grn_system_sso_sso_GRN_SY_SS_SS_72 append="validation_errors"}
       {grn_text name="target_url" class="target_url" necessary=true value="$target_url" size="50" disable_return_key=true maxlength="255"}
  </td>
 </tr>
 <tr>
  <th nowrap>
      {capture name='grn_system_sso_sso_GRN_SY_SS_SS_74'}{cb_msg module='grn.system.sso.sso' key='GRN_SY_SS_SS-74' replace='true'}{/capture}{grn_show_input_title title=$smarty.capture.grn_system_sso_sso_GRN_SY_SS_SS_74}
  </th>
  <td>
       {if $available_window== 1}
        {capture name='grn_system_sso_sso_GRN_SY_SS_SS_75'}{cb_msg module='grn.system.sso.sso' key='GRN_SY_SS_SS-75' replace='true'}{/capture}{grn_checkbox name="available_window" id="available_window" value="1" caption=$smarty.capture.grn_system_sso_sso_GRN_SY_SS_SS_75 checked=TRUE}
       {else}
        {capture name='grn_system_sso_sso_GRN_SY_SS_SS_76'}{cb_msg module='grn.system.sso.sso' key='GRN_SY_SS_SS-76' replace='true'}{/capture}{grn_checkbox name="available_window" id="available_window" value="1" caption=$smarty.capture.grn_system_sso_sso_GRN_SY_SS_SS_76}
       {/if}
       {if $available_personal == 1}
        {capture name='grn_system_sso_sso_GRN_SY_SS_SS_77'}{cb_msg module='grn.system.sso.sso' key='GRN_SY_SS_SS-77' replace='true'}{/capture}{grn_checkbox name="available_personal" id="available_personal" value="1" caption=$smarty.capture.grn_system_sso_sso_GRN_SY_SS_SS_77 checked=TRUE}
       {else}
        {capture name='grn_system_sso_sso_GRN_SY_SS_SS_78'}{cb_msg module='grn.system.sso.sso' key='GRN_SY_SS_SS-78' replace='true'}{/capture}{grn_checkbox name="available_personal" id="available_personal" value="1" caption=$smarty.capture.grn_system_sso_sso_GRN_SY_SS_SS_78}
       {/if}
  </td>
 </tr>
 <tr valign="top">
  <th nowrap>
      ...
      {capture name='grn_system_sso_sso_GRN_SY_SS_SS_79'}{cb_msg module='grn.system.sso.sso' key='GRN_SY_SS_SS-79' replace='true'}{/capture}{grn_show_input_title title=$smarty.capture.grn_system_sso_sso_GRN_SY_SS_SS_79}
  </th>
  <td style="padding:0px">
      <table class="std_form">
       <tr>
        <td>{cb_msg module='grn.system.sso.sso' key='GRN_SY_SS_SS-80' replace='true'}</td>
        <td>{cb_msg module='grn.system.sso.sso' key='GRN_SY_SS_SS-81' replace='true'}</td>
       </tr>
       <tr>
...
{/if}
         ...
         {if $personal_values.1 != ''}{grn_text id='personal_values1' name="personal_values[]" class=$values_class necessary=true value=$personal_param_values.1.value size="50" disable_return_key=true}
 ...
 <tr valign="top">
  <th nowrap>
      ...
      {capture name='grn_system_sso_sso_GRN_SY_SS_SS_82'}{cb_msg module='grn.system.sso.sso' key='GRN_SY_SS_SS-82' replace='true'}{/capture}{grn_show_input_title title=$smarty.capture.grn_system_sso_sso_GRN_SY_SS_SS_82}
  </th>
  <td style="padding:0px">
      <table>
       <tr>
        <td>{cb_msg module='grn.system.sso.sso' key='GRN_SY_SS_SS-83' replace='true'}</td>
        <td>{cb_msg module='grn.system.sso.sso' key='GRN_SY_SS_SS-84' replace='true'}</td>
       </tr>
       <tr>
...
{/if}
 ...
 <tr>
  <td></td>
  <td>
       {capture name='grn_system_sso_sso_GRN_SY_SS_SS_85'}{cb_msg module='grn.system.sso.sso' key='GRN_SY_SS_SS-85' replace='true'}{/capture}{grn_button_cancel class='margin' caption=$smarty.capture.grn_system_sso_sso_GRN_SY_SS_SS_85}
       {capture name='grn_system_sso_sso_GRN_SY_SS_SS_86'}{cb_msg module='grn.system.sso.sso' key='GRN_SY_SS_SS-86' replace='true'}{/capture}{grn_button_submit class="margin" caption=$smarty.capture.grn_system_sso_sso_GRN_SY_SS_SS_86}
       {capture name='grn_system_sso_sso_GRN_SY_SS_SS_87'}{cb_msg module='grn.system.sso.sso' key='GRN_SY_SS_SS-87' replace='true'}{/capture}{grn_button_cancel caption=$smarty.capture.grn_system_sso_sso_GRN_SY_SS_SS_87 page='system/sso/sso_method_list' sf=1}
  </td>
 </tr>
</table>
</form>
