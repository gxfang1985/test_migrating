...
{if $direct_flag}
 {if $truncated_caption}
  {grn_link caption=$caption truncated_caption=$truncated_caption image=$image page="$washed_url" target="$target" page_direct=TRUE}
 {else}
  {grn_link caption=$caption image=$image page="$washed_url" target="$target" page_direct=TRUE}
 {/if}
{else}
 {if $truncated_caption}
