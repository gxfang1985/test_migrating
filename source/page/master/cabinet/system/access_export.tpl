...
<form name="{$form_name}" method="post" action="{grn_pageurl page='cabinet/system/command_access_export' postfix='folder_access.csv'}"><input type="hidden" name="csrf_ticket" value="{$csrf_ticket}">
