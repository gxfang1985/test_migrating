...
<script language="JavaScript" type="text/javascript">
    ...
    G.moduleName = '{cb_msg module='grn.dezielink.system' key='GRN_DZL_SY-137' replace='true'}';
...
<p></p>
<div class="explanation">{cb_msg module='grn.dezielink.system' key='GRN_DZL_SY-1' replace='true'}</div>
<p></p>
...
<div>
  <form name="{$form_name}" id="form-content" method="POST" action="{grn_pageurl page='dezielink/system/command_'|cat:$page_info.last}">
    {include file='dezielink/system/_connector_modify.tpl'}
  </form>
</div>
