...
<form name="{$form_name}" method="post" action="{grn_pageurl page='portal/system/command_html_portlet_name_export' postfix='html_portlet_name.csv'}"><input type="hidden" name="csrf_ticket" value="{$csrf_ticket}">
