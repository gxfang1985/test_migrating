 ...
 <div id="action">
  ...
  <p class="item">
   <div class="contents_button">
    <div classs="word">
    {capture name='grn_report_system_GRN_RPRT_SY_251'}{cb_msg module='grn.report.system' key='GRN_RPRT_SY-251' replace='true'}{/capture}{grn_button_submit class='margin' caption=$smarty.capture.grn_report_system_GRN_RPRT_SY_251 onclick="grn_onsubmit_common(this.form);"}
    {grn_button_cancel}
    </div>
   </div>
  </p>
