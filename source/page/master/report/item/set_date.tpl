...
{if $display == 'add-system' || $display == 'modify-system'}
<form name="{$form_name}" method="post" action="{grn_pageurl page='report/system/item/command_set_date'}" enctype="multipart/form-data">
    {else}
<form name="{$form_name}" method="post" action="{grn_pageurl page='report/item/command_set_date'}" enctype="multipart/form-data">
{/if}
...
<table class="std_form">
 ...
 <tr>
  <th nowrap>{capture name='grn_report_item_GRN_RPRT_ITEM_107'}{cb_msg module='grn.report.item' key='GRN_RPRT_ITEM-107' replace='true'}{/capture}{grn_show_input_title title=$smarty.capture.grn_report_item_GRN_RPRT_ITEM_107}</th>
  <td>
     ...
     {/if}
     {capture name='grn_report_item_GRN_RPRT_ITEM_108'}{cb_msg module='grn.report.item' key='GRN_RPRT_ITEM-108' replace='true'}{/capture}{grn_radio name='initial_type' id='0' value='0' caption=$smarty.capture.grn_report_item_GRN_RPRT_ITEM_108 checked=$initial_type_0}<br>
     {capture name='grn_report_item_GRN_RPRT_ITEM_109'}{cb_msg module='grn.report.item' key='GRN_RPRT_ITEM-109' replace='true'}{/capture}{grn_radio name='initial_type' id='1' value='1' caption=$smarty.capture.grn_report_item_GRN_RPRT_ITEM_109 checked=$initial_type_1}
     {grn_select_date prefix='initial_' date=$initial_date form_name=$form_name}<br>
     {capture name='grn_report_item_GRN_RPRT_ITEM_110'}{cb_msg module='grn.report.item' key='GRN_RPRT_ITEM-110' replace='true'}{/capture}{grn_radio name='initial_type' id='2' value='2' caption=$smarty.capture.grn_report_item_GRN_RPRT_ITEM_110 checked=$initial_type_2}
  </td>
 </tr>
 <tr valign="top">
