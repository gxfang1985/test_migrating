 ...
 <div id="action">
  ...
  <p class="item">
   <div class="contents_button">
    <div classs="word">
    {capture name='grn_report_operation_GRN_RPRT_OP_221'}{cb_msg module='grn.report.operation' key='GRN_RPRT_OP-221' replace='true'}{/capture}{grn_button_submit class='margin' caption=$smarty.capture.grn_report_operation_GRN_RPRT_OP_221 onclick="grn_onsubmit_common(this.form);"}
    {grn_button_cancel}
    </div>
   </div>
  </p>
