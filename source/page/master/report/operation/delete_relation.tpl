<form name="report/delete" method="post" action="{grn_pageurl page='report/operation/command_report_schedule_relation'}"><input type="hidden" name="csrf_ticket" value="{$csrf_ticket}">
