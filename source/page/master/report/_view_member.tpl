...
{capture assign='id_when_list_of_attendee_closed'}display_member_addressee_close{/capture}
...
{capture assign='execute_open_list_of_attendee_javascript'}javascript:void(0);display_on_off('display_member_addressee_close:display_member_addressee_open:display_member_swith_image_open:display_member_swith_image_close'){/capture}
{capture assign='display_all_of_attendee'}{cb_msg module='grn.report' key='display_member' replace='true'}{/capture}
{capture assign='display_all_of_attendee_end'}{cb_msg module='grn.report' key='GRN_RPRT-250' replace='true'}{/capture}
{capture assign='id_when_list_of_attendee_open'}display_member_addressee_open{/capture}
{capture assign='message_of_display_off'}{cb_msg module='grn.report' key='GRN_RPRT-251' replace='true'}{/capture}
{capture assign='execute_close_list_of_attendee_javascript'}javascript:void(0);display_on_off('display_member_addressee_close:display_member_addressee_open:display_member_swith_image_open:display_member_swith_image_close'){/capture}
{capture assign='message_of_display_hide'}{cb_msg module='grn.report' key='hide_member' replace='true'}{/capture}
