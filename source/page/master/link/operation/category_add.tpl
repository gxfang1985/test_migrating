...
<p>{cb_msg module='grn.link.operation' key='GRN_LNK_OP-27' replace='true'}</p>

{include file="grn/show_validation_errors.tpl"}
{include file='grn/indispensable.tpl'}
 {include file='link/operation/_category_add.tpl' button_file='link/operation/_category_add_buttons.tpl'}
