...
<p>
 <input class="margin" type="submit" value="{cb_msg module='grn.link.system' key='GRN_LNK_SY-46' replace='true'}" onclick="grn_onsubmit_common(this.form);">{grn_button_cancel}
</p>
