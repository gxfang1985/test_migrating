...
<div style="text-align:center;">
    <div style="width:600px;margin:20px auto 20px auto;">
        <div style="text-align:left;">
            {cb_msg module='grn.space' key='appmanage-space-1' replace='true'}<br /><br />
            {cb_msg module='grn.space' key='appmanage-space-2' replace='true'}{$app.name}<br />
        </div>
        <br />
        <div>
            <form name="appmanage_add_link_check_form" method="post" action="{grn_pageurl page='space/command_appmanage_add_link'}"> 
