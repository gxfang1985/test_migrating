<div class="mobile-buttonArea-grn">
  ...
  <div class="mobile_cancel_grn mobile_show_overlay_js">
    <input type="button" data-inline="true" data-theme="{$data_theme}" onclick="location.href='{grn_pageurl page="mail/mobile/view" mid=$mid sp=$sp}';" value="{cb_msg module='grn.mail.mobile' key='GRN_MAIL_MOBILE-15' replace='true'}"/>
  </div>
</div>
