...
<div class="explanation mTop5">
    ...
    {cb_msg module='grn.workflow.system' key='GRN_WKF_SYS-138' replace='true'}
</div>
    ...
    {strip}
        <table class="std_form mTop10">
            ...
            <tr>
                ...
                <td>
                    <div>
                        {capture name='grn_customization_form_button_save'}{cb_msg module='grn.grn' key='GRN_GRN-1578' replace='true'}{/capture}
                        {capture name='grn_customization_form_button_cancel'}{cb_msg module='grn.grn' key='GRN_GRN-1579' replace='true'}{/capture}
