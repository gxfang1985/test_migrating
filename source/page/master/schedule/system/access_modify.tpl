...
{cb_msg module='grn.schedule.system' key='GRN_SCH_SY-138' replace='true'}
</div>

<p>
<table class="std_form">
<tr>
<th>{cb_msg module='grn.schedule.system' key='GRN_SCH_SY-139' replace='true'}</th>
<td>
...
<tr>
<th>{cb_msg module='grn.schedule.system' key='GRN_SCH_SY-140' replace='true'}</th>
<td>
...
{/if}
<input type="checkbox" name="read" id="authority_read" value="1" {$checked_read} onClick="change_on_off(this)"><label for="authority_read" onMouseOver="this.style.color='#ff0000'" onMouseOut="this.style.color=''">{cb_msg module='grn.schedule.system' key='GRN_SCH_SY-141' replace='true'}</label>
{capture name='grn_schedule_system_GRN_SCH_SY_142'}{cb_msg module='grn.schedule.system' key='GRN_SCH_SY-142' replace='true'}{/capture}{grn_checkbox name='add'    id='authority_add'    value='1' checked=$data_add caption=$smarty.capture.grn_schedule_system_GRN_SCH_SY_142}
{capture name='grn_schedule_system_GRN_SCH_SY_143'}{cb_msg module='grn.schedule.system' key='GRN_SCH_SY-143' replace='true'}{/capture}{grn_checkbox name='modify' id='authority_modify' value='1' checked=$data_modify caption=$smarty.capture.grn_schedule_system_GRN_SCH_SY_143}
{capture name='grn_schedule_system_GRN_SCH_SY_144'}{cb_msg module='grn.schedule.system' key='GRN_SCH_SY-144' replace='true'}{/capture}{grn_checkbox name='delete' id='authority_delete' value='1' checked=$data_delete caption=$smarty.capture.grn_schedule_system_GRN_SCH_SY_144}
</td>
</tr>
<tr>
<td></td>
<td>
{capture name='grn_schedule_system_GRN_SCH_SY_145'}{cb_msg module='grn.schedule.system' key='GRN_SCH_SY-145' replace='true'}{/capture}{grn_button_submit class="margin" caption=$smarty.capture.grn_schedule_system_GRN_SCH_SY_145}
{grn_button_cancel}
</td>
</tr>
</table>
