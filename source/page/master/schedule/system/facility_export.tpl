...
<form name="{$form_name}" method="post" action="{grn_pageurl page='schedule/system/command_'|cat:$page_info.last postfix='facilities.csv'}"><input type="hidden" name="csrf_ticket" value="{$csrf_ticket}">
...
<hr>
<p>
{include file='schedule/system/_facility_csv_columns.tpl'}
