...
<div class="tab_menu">
 ...
 {else}
  ...
  <span class="tab_off">
   {capture name='grn_grn_GRN_GRN_88'}{cb_msg module='grn.grn' key='GRN_GRN-88' replace='true'}{/capture}{grn_link image='user20.gif' page=$page_info.all poid=$poid params=$ous_params reset=1 caption=$smarty.capture.grn_grn_GRN_GRN_88 element_id="`$page_info.all`/user"}
  </span>
 ...
 {else}
  <span class="tab_left_off"></span>
  <span class="tab_off">
   {capture name='grn_grn_GRN_GRN_90'}{cb_msg module='grn.grn' key='GRN_GRN-90' replace='true'}{/capture}{grn_link image='role20.gif' page=$page_info.all menu='role' poid=$poid params=$ous_params reset=1 caption=$smarty.capture.grn_grn_GRN_GRN_90 element_id="`$page_info.all`/role"}
  </span>
  <span class="tab_right_off"></span>
 {/if}
 </div>
...
<p></p>
 <select name="rids[]" size="5" multiple style="width:100%">
...
<form name="{$form_name}" method="post" action="{grn_pageurl page=$post_page}">
 ...
 {/if}
 {capture name='grn_grn_GRN_GRN_1518'}{cb_msg module='grn.grn' key='GRN_GRN-1518' replace='true'}{/capture}{grn_button_submit class="margin" caption=$smarty.capture.grn_grn_GRN_GRN_1518 id="`$form_name`_submit"}
