...
<form name="{$form_name}" method="post" action="{grn_pageurl page='schedule/system/command_access_export' postfix='schedule_access.csv'}"><input type="hidden" name="csrf_ticket" value="{$csrf_ticket}">
...
<hr>
<p>
{include file='schedule/system/_access_csv_columns.tpl'}
