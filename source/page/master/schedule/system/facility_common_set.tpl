...
<form name="{$form_name}" method="post" action="{grn_pageurl page='schedule/system/command_'|cat:$page_info.last}">
    ...
    <p></p>
    <div class="attention">{cb_msg module='grn.schedule.system' key='GRN_SCH_SY-545' replace='true'}</div>
    <p></p>
    <table class="std_form">
        ...
        <tr>
            <td>
                ...
                {/if}
                <select name="scheduled_time_hour">
                ...
                <select name="scheduled_time_minute">
        ...
        <tr>
            <td></td>
            <td>
                <input type="button" class="margin" onclick="grn.page.schedule.system.facility_set.submitForm(this.form);" value="{cb_msg module='grn.schedule.system' key='GRN_SCH_SY-551' replace='true'}">
                {grn_button_cancel page='schedule/system/facility_select_set'}
            </td>
        </tr>
    </table>
</form>
