...
<form name="{$form_name}" method="post" action="{grn_pageurl page='schedule/system/command_'|cat:$page_info.last postfix='facilitygroup_name.csv'}"><input type="hidden" name="csrf_ticket" value="{$csrf_ticket}">
