...
<table class="std_form">
 <tr>
  <th nowrap>
      {cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-52' replace='true'}
  </th>
  <td>
 ...
 <tr valign="top">
  <th nowrap>
      {cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-53' replace='true'}
  </th>
  <td>
...
<table border="0" cellspacing="0">
 <tr>
  ...
  <td class="item_right_left">
   <br><br><br><input type="button" value="{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-55' replace='true'}" onClick="EnterMember( this.form, 'CID[]', 'CID[]' )">

   <br><br><br><br><br><br><br><br><br><input type="button" value="{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-56' replace='true'}" onClick="EnterMember( this.form, 'cITEM[]', 'cITEM[]', true )">
  </td>
  <td>
   ...
   <input type="button" value="{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-57' replace='true'}" onClick="SearchCGID( this.form, '{grn_pageurl page='grn/user_add_search_users'}' );">
   <div class="margin_top">
{if $display == 'set-system'}
 {capture name='grn_schedule_portlet_GRN_SCH_PO_58'}{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-58' replace='true'}{/capture}{grn_popup_user_select_link caption=$smarty.capture.grn_schedule_portlet_GRN_SCH_PO_58 form_name=$form_name select_name=$sUID system=true system_display=true include_org=$show_organize no_multiple=true access_plugin=$access_plugin plugin_session_name=$plugin_session_name plugin_data_name=$plugin_data_name}
{else}
 {capture name='grn_schedule_portlet_GRN_SCH_PO_59'}{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-59' replace='true'}{/capture}{grn_popup_user_select_link caption=$smarty.capture.grn_schedule_portlet_GRN_SCH_PO_59 form_name=$form_name select_name=$sUID system=false system_display=false include_org=$show_organize no_multiple=true access_plugin=$access_plugin plugin_session_name=$plugin_session_name plugin_data_name=$plugin_data_name}
{/if}
   </div>
...
<!-- category select -->
   ...
   <select id="CGID" name="CGID" onChange="ChangeCGID( this.form );">
    <option value="login" selected>{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-60' replace='true'}</option>
   </select>
...
function ChangeCGID( form )
{
  ...
  item_options['login'][0].text = '{/literal}{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-61' replace='true'}{literal}';
...
<!-- item select -->
   ...
   <select name="CID[]" size=8 multiple class="select_multiple_display_grn" style="min-width:500px;">
    <option value="0" selected>{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-62' replace='true'}</option>
    <option value="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
   </select>
   </div>
<!-- item select -->
...
<!-- userinfo list -->
   <div class="margin_vert">
{if $display == 'set-system'}
 {capture name='grn_schedule_portlet_GRN_SCH_PO_63'}{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-63' replace='true'}{/capture}{grn_popup_user_list_link caption=$smarty.capture.grn_schedule_portlet_GRN_SCH_PO_63 form_name=$form_name system_display=true}
{else}
 {capture name='grn_schedule_portlet_GRN_SCH_PO_64'}{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-64' replace='true'}{/capture}{grn_popup_user_list_link caption=$smarty.capture.grn_schedule_portlet_GRN_SCH_PO_64 form_name=$form_name system_display=false}
{/if}
   </div>
<!-- userinfo list -->
...
<input type="button" onclick="searchFacility( '{$page_name}' );" value="{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-65' replace='true'}"/>
...
{/foreach}
 ...
 {/if}
    ...
    <table cellspacing="0" cellpadding="0" border="0" style="{if ! $show_affiliation_group}display:none;{/if} margin-top:2px;" class="facility_group_path" id="facility-group">
       <tbody><tr valign="top">
              <td nowrap="">{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-66' replace='true'}</td>
              <td> <span style="" id="selected-path"></span> </td> </tr>
       </tbody>
 </table>
<div class="margin_top">
{capture name='grn_schedule_portlet_GRN_SCH_PO_67'}{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-67' replace='true'}{/capture}{grn_popup_facility_list_link caption=$smarty.capture.grn_schedule_portlet_GRN_SCH_PO_67 form_name=$form_name var_CID='cITEM[]' system_display=false duplication=$duplication}
           </div>
...
function selectFacility()
{
  ...
  if ( num_selected_items  != 1){
	...
	tmpArray.push( data['ancestors'][i]['name'].escapeHTML() );
      ...
      parent_path_node.innerHTML = '{/literal}{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-69' replace='true'}{literal}';
    }
  }
}
...
{/if}
 ...
 <tr>
  ...
  <td>
       {if $display == 'set-system'}
        {capture name='grn_schedule_portlet_GRN_SCH_PO_70'}{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-70' replace='true'}{/capture}{grn_button_submit class="margin" caption=$smarty.capture.grn_schedule_portlet_GRN_SCH_PO_70}
        {capture name='grn_schedule_portlet_GRN_SCH_PO_71'}{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-71' replace='true'}{/capture}{grn_button_cancel caption=$smarty.capture.grn_schedule_portlet_GRN_SCH_PO_71 page='portal/system/view' pid=$portlet.pid}
       {elseif $display == 'set-operation'}
        {capture name='grn_schedule_portlet_GRN_SCH_PO_72'}{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-72' replace='true'}{/capture}{grn_button_submit class="margin" caption=$smarty.capture.grn_schedule_portlet_GRN_SCH_PO_72}
        {capture name='grn_schedule_portlet_GRN_SCH_PO_73'}{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-73' replace='true'}{/capture}{grn_button_cancel caption=$smarty.capture.grn_schedule_portlet_GRN_SCH_PO_73 page='portal/operation/view' pid=$portlet.pid}
       {else}
        {capture name='grn_schedule_portlet_GRN_SCH_PO_74'}{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-74' replace='true'}{/capture}{grn_button_submit class="margin" caption=$smarty.capture.grn_schedule_portlet_GRN_SCH_PO_74 onclick="PrepareSubmit( this.form );"}
        {capture name='grn_schedule_portlet_GRN_SCH_PO_75'}{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-75' replace='true'}{/capture}{grn_button_cancel caption=$smarty.capture.grn_schedule_portlet_GRN_SCH_PO_75 page='portal/personal/view' pid=$portlet.pid}
       {/if}
  </td>
 </tr>
</table>
