...
<table class="std_form">
 <tr>
  <th nowrap>
      {cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-87' replace='true'}
  </th>
  <td>
 ...
 <tr valign="top">
  <th nowrap>
      {cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-88' replace='true'}
  </th>
  <td>
...
<table border="0" cellspacing="0">
 <tr>
  ...
  <td class="item_right_left">
   <br><br><br><input type="button" value="{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-90' replace='true'}" onClick="EnterMember( this.form, 'CID[]', 'CID[]' )">

    <br><br><br><br><br><br><br><br><br><input type="button" value="{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-91' replace='true'}" onClick="EnterMember( this.form, 'cITEM[]', 'cITEM[]',true )">
  ...
  <td>
   ...
   <input type="button" value="{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-92' replace='true'}" onClick="SearchCGID( this.form, '{grn_pageurl page='grn/user_add_search_users'}' );">
   <div class="margin_top">
{if $display == 'set-system'}
 {capture name='grn_schedule_portlet_GRN_SCH_PO_93'}{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-93' replace='true'}{/capture}{grn_popup_user_select_link caption=$smarty.capture.grn_schedule_portlet_GRN_SCH_PO_93 form_name=$form_name select_name=$sUID system=true system_display=true include_org=$show_organize no_multiple=true access_plugin=$access_plugin plugin_session_name=$plugin_session_name plugin_data_name=$plugin_data_name}
{else}
 {capture name='grn_schedule_portlet_GRN_SCH_PO_94'}{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-94' replace='true'}{/capture}{grn_popup_user_select_link caption=$smarty.capture.grn_schedule_portlet_GRN_SCH_PO_94 form_name=$form_name select_name=$sUID system=false system_display=false include_org=$show_organize no_multiple=true access_plugin=$access_plugin plugin_session_name=$plugin_session_name plugin_data_name=$plugin_data_name}
{/if}
   </div>
...
<!-- category select -->
   ...
   <select id="CGID" name="CGID" onChange="ChangeCGID( this.form );">
    <option value="login" selected>{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-95' replace='true'}</option>
   </select>
...
function ChangeCGID( form )
{
  ...
  item_options['login'][0].text = '{/literal}{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-96' replace='true'}{literal}';
...
<!-- item select -->
   ...
   <select name="CID[]" size=8 class="select_multiple_display_grn" style="min-width:500px;">
    <option value="0" selected>{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-97' replace='true'}</option>
    <option value="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
   </select>
   </div>
<!-- item select -->
...
<!-- userinfo list -->
   <div class="margin_vert">
{if $display == 'set-system'}
 {capture name='grn_schedule_portlet_GRN_SCH_PO_98'}{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-98' replace='true'}{/capture}{grn_popup_user_list_link caption=$smarty.capture.grn_schedule_portlet_GRN_SCH_PO_98 form_name=$form_name system_display=true}
{else}
 {capture name='grn_schedule_portlet_GRN_SCH_PO_99'}{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-99' replace='true'}{/capture}{grn_popup_user_list_link caption=$smarty.capture.grn_schedule_portlet_GRN_SCH_PO_99 form_name=$form_name system_display=false}
{/if}
   </div>
<!-- userinfo list -->
...
<input type="button" onclick="searchFacility( '{$page_name}' );" value="{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-100' replace='true'}"/>
...
{/foreach}
 ...
 {/if}
    ...
    <table cellspacing="0" cellpadding="0" border="0" style="{if ! $show_affiliation_group}display:none;{/if} margin-top:2px;" class="facility_group_path" id="facility-group">
       <tbody><tr valign="top">
              <td nowrap="">{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-101' replace='true'}</td>
              <td> <span style="" id="selected-path"></span> </td> </tr>
       </tbody>
 </table>
<div class="margin_top">
{capture name='grn_schedule_portlet_GRN_SCH_PO_102'}{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-102' replace='true'}{/capture}{grn_popup_facility_list_link caption=$smarty.capture.grn_schedule_portlet_GRN_SCH_PO_102 form_name=$form_name var_CID='cITEM[]' system_display=false duplication=$duplication}
           </div>
...
function ChangeITEM( form_name, argLoadItem )
{
  ...
  request.send().done(function (facility_cache) {
...
function searchFacility( form_name )
{
  ...
  requestPage.send().done(function (facility_cache) {
      ...
      form.elements['cITEM[]'].disabled = false;
      form.elements['cITEM[]'].focus();
      YAHOO.global.updateTitle('{/literal}{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-103' replace='true'}{literal}');
  });

  YAHOO.global.dropdown.facility.insertNode(
      {"oid":"s", "name":'{/literal}{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-103' replace='true'}{literal}', 'is_selected': true, 'extra_param':'1', 'count':0, 'children':[] } );
}
...
function selectFacility()
{
  ...
  if ( num_selected_items  != 1){
	...
	tmpArray.push( data['ancestors'][i]['name'].escapeHTML() );
      ...
      parent_path_node.innerHTML = '{/literal}{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-104' replace='true'}{literal}';
    }
  }
}
...
{/if}
 ...
 <tr>
  ...
  <td>
       {if $display == 'set-system'}
        {capture name='grn_schedule_portlet_GRN_SCH_PO_105'}{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-105' replace='true'}{/capture}{grn_button_submit class="margin" caption=$smarty.capture.grn_schedule_portlet_GRN_SCH_PO_105}
        {capture name='grn_schedule_portlet_GRN_SCH_PO_106'}{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-106' replace='true'}{/capture}{grn_button_cancel caption=$smarty.capture.grn_schedule_portlet_GRN_SCH_PO_106 page='portal/system/view' pid=$portlet.pid}
       {elseif $display == 'set-operation'}
        {capture name='grn_schedule_portlet_GRN_SCH_PO_107'}{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-107' replace='true'}{/capture}{grn_button_submit class="margin" caption=$smarty.capture.grn_schedule_portlet_GRN_SCH_PO_107}
        {capture name='grn_schedule_portlet_GRN_SCH_PO_108'}{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-108' replace='true'}{/capture}{grn_button_cancel caption=$smarty.capture.grn_schedule_portlet_GRN_SCH_PO_108 page='portal/operation/view' pid=$portlet.pid}
       {else}
        {capture name='grn_schedule_portlet_GRN_SCH_PO_109'}{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-109' replace='true'}{/capture}{grn_button_submit class="margin" caption=$smarty.capture.grn_schedule_portlet_GRN_SCH_PO_109 onclick="PrepareSubmit( this.form );"}
        {capture name='grn_schedule_portlet_GRN_SCH_PO_110'}{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-110' replace='true'}{/capture}{grn_button_cancel caption=$smarty.capture.grn_schedule_portlet_GRN_SCH_PO_110 page='portal/personal/view' pid=$portlet.pid}
       {/if}
  </td>
 </tr>
</table>
