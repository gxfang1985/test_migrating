...
<table class="std_form" width="100%">
 ...
 <tr>
  <th nowrap>
      {cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-1' replace='true'}
  </th>
  <td>
 ...
 <tr valign="top">
  <th nowrap>
      {cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-2' replace='true'}
  </th>
  <td class='tvw'>
     ...
     {/if}
<div>
{capture name='grn_schedule_portlet_GRN_SCH_PO_3'}{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-3' replace='true'}{/capture}{grn_radio name='group' id='login_user' value='login' caption=$smarty.capture.grn_schedule_portlet_GRN_SCH_PO_3 checked=$check_login}
</div>
...
{capture name='grn_schedule_portlet_GRN_SCH_PO_4'}{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-4' replace='true'}{/capture}{grn_radio name='group' id='mygroup' value='mygroup' caption=$smarty.capture.grn_schedule_portlet_GRN_SCH_PO_4 checked=$check_mygroup}
...
{capture name='grn_schedule_portlet_GRN_SCH_PO_5'}{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-5' replace='true'}{/capture}{grn_radio name='group' id='organization' value='org' caption=$smarty.capture.grn_schedule_portlet_GRN_SCH_PO_5 checked=$check_organization disabled=$disabled_organization}
</div>
...
{include file="schedule/portlet/_organization_select.tpl"}
 ...
 <tr>
  <td></td>
  <td>
       <input class="margin" type="submit" name="apply" value="{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-6' replace='true'}">
       <input type="submit" name="cancel" value="{cb_msg module='grn.schedule.portlet' key='GRN_SCH_PO-7' replace='true'}">
  </td>
 </tr>
</table>
