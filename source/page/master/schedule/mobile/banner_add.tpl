...
<form id="schedule_mobile_banner_add" name="{$form_name}" method="post" enctype="multipart/form-data" action="{grn_pageurl page='schedule/mobile/command_add'}" data-ajax="false">
...
<div data-role="content" class="mobile-content-grn" data-theme="{$data_theme}">
  ...
  {/if}
  {include file="schedule/mobile/_add_button.tpl" form_id='schedule_mobile_banner_add'}
