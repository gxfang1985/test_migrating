...
{grn_cellular_form name=$form_name method=post page="$pagepath/command_change" cid=$cid}
...
{grn_cellular_submit accesskey=1 caption_module='grn.message.cellular' caption_key="submit_change"}
</form>
