...
{capture name='grn_bulletin_portlet_GRN_BLLT_PTLT_27'}{cb_msg module='grn.bulletin.portlet' key='GRN_BLLT_PTLT-27' replace='true'}{/capture}{grn_checkbox name='show_mtime'    id='show_mtime'    value=1 caption=$smarty.capture.grn_bulletin_portlet_GRN_BLLT_PTLT_27 checked=0}
{else}
{capture name='grn_bulletin_portlet_GRN_BLLT_PTLT_27'}{cb_msg module='grn.bulletin.portlet' key='GRN_BLLT_PTLT-27' replace='true'}{/capture}{grn_checkbox name='show_mtime'    id='show_mtime'    value=1 caption=$smarty.capture.grn_bulletin_portlet_GRN_BLLT_PTLT_27 checked=1}
{/if}
{if $portlet.settings.hide_columns.abstract}
{capture name='grn_bulletin_portlet_GRN_BLLT_PTLT_9'}{cb_msg module='grn.bulletin.portlet' key='GRN_BLLT_PTLT-9' replace='true'}{/capture}{grn_checkbox name='show_abstract' id='show_abstract' value=1 caption=$smarty.capture.grn_bulletin_portlet_GRN_BLLT_PTLT_9     checked=0}
{else}
{capture name='grn_bulletin_portlet_GRN_BLLT_PTLT_9'}{cb_msg module='grn.bulletin.portlet' key='GRN_BLLT_PTLT-9' replace='true'}{/capture}{grn_checkbox name='show_abstract' id='show_abstract' value=1 caption=$smarty.capture.grn_bulletin_portlet_GRN_BLLT_PTLT_9     checked=1}
{/if}
  </td>
 </tr>
 <tr>
