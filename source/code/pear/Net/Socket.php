...
class Net_Socket extends PEAR
{
     ...
     * @param boolean $use_ssl    Set use SSL or not, default FALSE
     *
     * @access public
     *
    ...
    function connect($addr, $port = 0, $persistent = null,
                     $timeout = null, $options = null, $use_ssl= FALSE )
    {
    ...
    function write($data, $blocksize = null)
    {
        ...
        while ($pos < $size) {
            ...
            if (!$written) {
                ...
                } else if( $meta_data['eof'] ) {
                    return $this->raiseError('connection closed');
                }
