...
class PHPExcel_Style_Conditional implements PHPExcel_IComparable
{
     ...
     */
    public function setConditionType(
        $pValue = PHPExcel_Style_Conditional::CONDITION_NONE
    ) {
     ...
     * @return PHPExcel_Style_Conditional
     */
    public function setOperatorType(
        $pValue = PHPExcel_Style_Conditional::OPERATOR_NONE
    ) {
