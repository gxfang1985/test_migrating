...
class PHPExcel_Worksheet_PageSetup
{
     ...
     */
    public function setPaperSize(
        $pValue = PHPExcel_Worksheet_PageSetup::PAPERSIZE_LETTER
    ) {
    ...
    public function setOrientation(
        $pValue = PHPExcel_Worksheet_PageSetup::ORIENTATION_DEFAULT
    ) {
    ...
    public function isColumnsToRepeatAtLeftSet()
    {
        if (is_array($this->_columnsToRepeatAtLeft)) {
            if ($this->_columnsToRepeatAtLeft[0] != ''
     ...
     * @return PHPExcel_Worksheet_PageSetup
     */
    public function setColumnsToRepeatAtLeftByStartAndEnd(
        $pStart = 'A',
        $pEnd = 'A'
    ) {
    ...
    public function isRowsToRepeatAtTopSet()
    {
        if (is_array($this->_rowsToRepeatAtTop)) {
            if ($this->_rowsToRepeatAtTop[0] != 0
                && $this->_rowsToRepeatAtTop[1] != 0
            ) {
                return true;
            }
        }
    ...
    public function setPrintAreaByColumnAndRow(
        ...
        return $this->setPrintArea(PHPExcel_Cell::stringFromColumnIndex($column1)
                                   . $row1 . ':'
     ...
     * @throws    PHPExcel_Exception
     */
    public function addPrintAreaByColumnAndRow(
        $column1,
        $row1,
        $column2,
        $row2,
        ...
        return $this->setPrintArea(PHPExcel_Cell::stringFromColumnIndex($column1)
                                   . $row1 . ':'
                                   . PHPExcel_Cell::stringFromColumnIndex($column2)
                                   . $row2, $index, self::SETPRINTRANGE_INSERT);
    }
