...
class PHPExcel_Worksheet_AutoFilter_Column
{
    ...
    public function __construct(
        $pColumn,
        PHPExcel_Worksheet_AutoFilter $pParent = null
    ) {
    ...
    public function setFilterType(
        $pFilterType = self::AUTOFILTER_FILTERTYPE_FILTER
    ) {
    ...
    public function getRule($pIndex)
    {
        if ( ! isset($this->_ruleset[$pIndex])) {
            $this->_ruleset[$pIndex]
                = new PHPExcel_Worksheet_AutoFilter_Column_Rule($this);
        }
