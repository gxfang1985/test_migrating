 ...
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class PHPExcel_Worksheet_ColumnCellIterator
    extends PHPExcel_Worksheet_CellIterator implements Iterator
{
    /**
     * Column index
     *
    ...
    public function __construct(
        ...
        $this->_columnIndex = PHPExcel_Cell::columnIndexFromString($columnIndex)
                              - 1;
    ...
    public function seek($row = 1)
    {
        if (($row < $this->_startRow) || ($row > $this->_endRow)) {
            throw new PHPExcel_Exception("Row $row is out of range ({$this->_startRow} - {$this->_endRow})");
                  ...
                  && ! ($this->_subject->cellExistsByColumnAndRow($this->_columnIndex,
                $row))
        ) {
    ...
    {
        return $this->_subject->getCellByColumnAndRow($this->_columnIndex,
            $this->_position);
    }
    ...
    protected function adjustForExistingOnlyRange()
    {
        if ($this->_onlyExistingCells) {
            while (( ! $this->_subject->cellExistsByColumnAndRow($this->_columnIndex,
                    $this->_startRow))
