...
class PHPExcel_Settings
{
    ...
    public static function setCacheStorageMethod(
        ...
        return PHPExcel_CachedObjectStorageFactory::initialize($method,
            $arguments);
    ...
    {
        if ((file_exists($libraryBaseDir) === false)
    ...
    public static function setLibXmlLoaderOptions($options = null)
    {
        ...
        if (version_compare(PHP_VERSION, '5.2.11') >= 0) {
            @libxml_disable_entity_loader($options == (LIBXML_DTDLOAD
                                                       | LIBXML_DTDATTR));
        }
    ...
    public static function getLibXmlLoaderOptions()
    {
        ...
        if (version_compare(PHP_VERSION, '5.2.11') >= 0) {
            @libxml_disable_entity_loader(self::$_libXmlLoaderOptions
