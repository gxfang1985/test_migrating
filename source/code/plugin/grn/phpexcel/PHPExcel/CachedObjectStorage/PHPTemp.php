    ...
    implements PHPExcel_CachedObjectStorage_ICache
{
    ...
    public function getCacheData($pCoord)
    {
        ...
        $this->_currentObject = unserialize(fread($this->_fileHandle,
            $this->_cellCache[$pCoord]['sz']));
    ...
    public function copyCellCollection(PHPExcel_Worksheet $parent)
    {
        ...
        $newFileHandle = fopen('php://temp/maxmemory:'
                               . $this->_memoryCacheSize, 'a+');
    ...
    {
        $this->_memoryCacheSize = (isset($arguments['memoryCacheSize']))
            ? $arguments['memoryCacheSize'] : '1MB';

        parent::__construct($parent);
        if (is_null($this->_fileHandle)) {
            $this->_fileHandle = fopen('php://temp/maxmemory:'
                                       . $this->_memoryCacheSize, 'a+');
        }
