    ...
    implements PHPExcel_CachedObjectStorage_ICache
{
    ...
    protected function _storeData()
    {
        if ($this->_currentCellIsDirty && ! empty($this->_currentObjectID)) {
            ...
            if ( ! $this->_DBHandle->queryExec("INSERT OR REPLACE INTO kvp_"
                                               . $this->_TableName . " VALUES('"
    ...
    public function getCacheData($pCoord)
    {
        ...
        $query = "SELECT value FROM kvp_" . $this->_TableName
                 . " WHERE id='" . $pCoord . "'";
    ...
    public function deleteCacheData($pCoord)
    {
        ...
        //	Check if the requested entry exists in the cache
        $query = "DELETE FROM kvp_" . $this->_TableName . " WHERE id='"
                 . $pCoord . "'";
    ...
    public function moveCell($fromAddress, $toAddress)
    {
        ...
        $query = "UPDATE kvp_" . $this->_TableName . " SET id='" . $toAddress
    ...
    public function getCellList()
    {
        ...
        $query = "SELECT id FROM kvp_" . $this->_TableName;
        $cellIdsResult = $this->_DBHandle->unbufferedQuery($query,
            SQLITE_ASSOC);
    ...
    public function __construct(PHPExcel_Worksheet $parent)
    {
        ...
        if (is_null($this->_DBHandle)) {
            ...
            if ( ! $this->_DBHandle->queryExec('CREATE TABLE kvp_'
                                               . $this->_TableName
