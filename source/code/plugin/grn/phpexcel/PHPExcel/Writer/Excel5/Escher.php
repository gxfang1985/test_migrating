        ...
        switch (get_class($this->_object)) {
            ...
            case 'PHPExcel_Shared_Escher_DggContainer':
                ...
                if ($bstoreContainer = $this->_object->getBstoreContainer()) {
                    $writer
                        = new PHPExcel_Writer_Excel5_Escher($bstoreContainer);
            ...
            case 'PHPExcel_Shared_Escher_DggContainer_BstoreContainer_BSE':
                ...
                $unused2 = 0x0;
                $unused3 = 0x0;
                $data .= pack('vVVVCCCC', $tag, $size, $cRef, $foDelay,
            ...
            case 'PHPExcel_Shared_Escher_DgContainer_SpgrContainer_SpContainer':
                ...
                $data .= $header . pack('VV', $this->_object->getSpId(),
                        $this->_object->getSpgr() ? 0x0005 : 0x0A00);
                ...
                if ($this->_object->getOPTCollection()) {
                    ...
                    $recType = 0xF00B;
                    foreach (
                        $this->_object->getOPTCollection() as $property =>
                        $value
                    ) {
                ...
                if ($this->_object->getStartCoordinates()) {
                    ...
                    // end coordinates
                    list($column, $row)
                        = PHPExcel_Cell::coordinateFromString($this->_object->getEndCoordinates());
