    ...
    extends PHPExcel_Writer_Excel2007_WriterPart
{
    ...
    public function _writeComment(
        ...
        $this->getParentWriter()->getWriterPart('stringtable')
    ...
    public function _writeVMLComment(
        ...
        $objWriter->writeAttribute('style',
            ...
            . ';margin-top:' . $pComment->getMarginTop() . ';width:'
            . $pComment->getWidth() . ';height:' . $pComment->getHeight()
            . ';z-index:1;visibility:' . ($pComment->getVisible() ? 'visible'
                : 'hidden'));
