    ...
    public function createStringTable($pSheet = null, $pExistingTable = null)
    {
        if ($pSheet !== null) {
            ...
            foreach ($pSheet->getCellCollection() as $cellID) {
                ...
                if ( ! is_object($cellValue) && ($cellValue !== null)
                     && $cellValue !== ''
                     &&
        ...
        if ($pStringTable !== null) {
            ...
            foreach ($pStringTable as $textElement) {
                ...
                if ( ! $textElement instanceof PHPExcel_RichText) {
                    $textToWrite
                        = PHPExcel_Shared_String::ControlCharacterPHP2OOXML($textElement);
    ...
    public function writeRichText(
        ...
        foreach ($elements as $element) {
            ...
            if ($element instanceof PHPExcel_RichText_Run) {
                ...
                $objWriter->writeAttribute('val',
                    ($element->getFont()->getBold() ? 'true' : 'false'));
                $objWriter->endElement();

                // Italic
                $objWriter->startElement($prefix . 'i');
                $objWriter->writeAttribute('val',
                    ($element->getFont()->getItalic() ? 'true' : 'false'));
                $objWriter->endElement();
