...
class PHPExcel_Reader_Excel5_Escher
{
    ...
    public function load($data)
    {
        ...
        while ($this->_pos < $this->_dataSize) {
            ...
            $fbt = PHPExcel_Reader_Excel5::_GetInt2d($this->_data,
                $this->_pos + 2);
    ...
    private function _readDefault()
    {
        ...
        $verInstance = PHPExcel_Reader_Excel5::_GetInt2d($this->_data,
            $this->_pos);
        ...
        $length = PHPExcel_Reader_Excel5::_GetInt4d($this->_data,
            $this->_pos + 4);
    ...
    private function _readBSE()
    {
        ...
        $recInstance = (0xFFF0 & PHPExcel_Reader_Excel5::_GetInt2d($this->_data,
                    $this->_pos)) >> 4;
    ...
    private function _readClientAnchor()
    {
        ...
        $this->_object->setStartCoordinates(PHPExcel_Cell::stringFromColumnIndex($c1)
                                            . ($r1 + 1));
        ...
        $this->_object->setEndCoordinates(PHPExcel_Cell::stringFromColumnIndex($c2)
                                          . ($r2 + 1));
