    ...
    PHPExcel_Properties
{
    ...
    public function setAxisOptionsProperties(
        ...
        ($horizontal_crosses_value !== null)
            ? $this->_axis_options['horizontal_crosses_value']
            = (string)$horizontal_crosses_value : null;
        ($horizontal_crosses !== null) ?
            $this->_axis_options['horizontal_crosses']
                = (string)$horizontal_crosses : null;
        ($axis_orientation !== null) ?
            $this->_axis_options['orientation'] = (string)$axis_orientation
            : null;
        ($major_tmt !== null) ?
            $this->_axis_options['major_tick_mark'] = (string)$major_tmt : null;
        ($minor_tmt !== null) ?
            $this->_axis_options['minor_tick_mark'] = (string)$minor_tmt : null;
        ($minor_tmt !== null) ?
            $this->_axis_options['minor_tick_mark'] = (string)$minor_tmt : null;
        ($minimum !== null) ? $this->_axis_options['minimum'] = (string)$minimum
            : null;
        ($maximum !== null) ? $this->_axis_options['maximum'] = (string)$maximum
            : null;
        ($major_unit !== null) ?
            $this->_axis_options['major_unit'] = (string)$major_unit : null;
        ($minor_unit !== null) ?
            $this->_axis_options['minor_unit'] = (string)$minor_unit : null;
    }
    ...
    public function setFillParameters(
        $color,
        $alpha = 0,
        $type = self::EXCEL_COLOR_TYPE_ARGB
    ) {
        $this->_fill_properties = $this->setColorProperties($color, $alpha,
            $type);
    }
    ...
    public function setLineParameters(
        $color,
        $alpha = 0,
        $type = self::EXCEL_COLOR_TYPE_ARGB
    ) {
        $this->_line_properties = $this->setColorProperties($color, $alpha,
            $type);
    }
    ...
    public function setLineStyleProperties(
        ...
        ( ! is_null($line_width)) ? $this->_line_style_properties['width']
            = $this->getExcelPointsWidth((float)$line_width)
            : null;
        ( ! is_null($compound_type)) ?
            $this->_line_style_properties['compound'] = (string)$compound_type
            : null;
        ( ! is_null($dash_type)) ?
            $this->_line_style_properties['dash'] = (string)$dash_type : null;
        ( ! is_null($cap_type)) ?
            $this->_line_style_properties['cap'] = (string)$cap_type : null;
        ( ! is_null($join_type)) ?
            $this->_line_style_properties['join'] = (string)$join_type : null;
        ( ! is_null($head_arrow_type)) ?
            $this->_line_style_properties['arrow']['head']['type']
                = (string)$head_arrow_type
            : null;
        ( ! is_null($head_arrow_size)) ?
            $this->_line_style_properties['arrow']['head']['size']
                = (string)$head_arrow_size
            : null;
        ( ! is_null($end_arrow_type)) ?
            $this->_line_style_properties['arrow']['end']['type']
                = (string)$end_arrow_type
            : null;
        ( ! is_null($end_arrow_size)) ?
            $this->_line_style_properties['arrow']['end']['size']
    ...
    {
        return $this->getArrayElementsValue($this->_line_style_properties,
            $elements);
    }
    ...
    {
        return $this->getLineStyleArrowSize($this->_line_style_properties['arrow'][$arrow]['size'],
            'w');
    }
    ...
    public function setShadowProperties(
        ...
        $this
            ...
            ->_setShadowColor(
                is_null($sh_color_value)
                    ? $this->_shadow_properties['color']['value']
                    : $sh_color_value
                , is_null($sh_color_alpha)
                ? (int)$this->_shadow_properties['color']['alpha']
                : $sh_color_alpha
                , is_null($sh_color_type)
                ? $this->_shadow_properties['color']['type'] : $sh_color_type)
    ...
    private function _setShadowProperiesMapValues(
    ...
    {
        $this->_shadow_properties['color'] = $this->setColorProperties($color,
            $alpha, $type);
    ...
    {
        if ($blur !== null) {
            $this->_shadow_properties['blur']
                = (string)$this->getExcelPointsWidth($blur);
        }
    ...
    {
        if ($angle !== null) {
            $this->_shadow_properties['direction']
                = (string)$this->getExcelPointsAngle($angle);
        }
    ...
    {
        if ($distance !== null) {
            $this->_shadow_properties['distance']
                = (string)$this->getExcelPointsWidth($distance);
        }
    ...
    {
        return $this->getArrayElementsValue($this->_shadow_properties,
            $elements);
    }
    ...
    public function setGlowProperties(
        $size,
        $color_value = null,
        $color_alpha = null,
        $color_type = null
        ...
        $this
            ...
            ->_setGlowColor(
                is_null($color_value)
                    ? $this->_glow_properties['color']['value'] : $color_value
                , is_null($color_alpha)
                ? (int)$this->_glow_properties['color']['alpha'] : $color_alpha
                ,
                is_null($color_type) ? $this->_glow_properties['color']['type']
                    : $color_type);
    }
    ...
    {
        $this->_glow_properties['color'] = $this->setColorProperties($color,
            $alpha, $type);
