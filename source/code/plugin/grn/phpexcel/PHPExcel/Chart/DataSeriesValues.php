...
class PHPExcel_Chart_DataSeriesValues
{
    ...
    {
        $this->_dataValues
            = PHPExcel_Calculation_Functions::flattenArray($dataValues);
    ...
    public function refresh(PHPExcel_Worksheet $worksheet, $flatten = true)
    {
        if ($this->_dataSource !== null) {
            $calcEngine
                = PHPExcel_Calculation::getInstance($worksheet->getParent());
            ...
            if ($flatten) {
                $this->_dataValues
                    = PHPExcel_Calculation_Functions::flattenArray($newDataValues);
                ...
                $dimensions = PHPExcel_Cell::rangeDimension(str_replace('$', '',
                    $cellRange));
