...
$error['EN'][PolymorphicArgumentException]
...
$error['FR'][MatrixDimensionException]
    = "Les dimensions de Matrix ne sont pas égales.";
...
$error['FR'][PrecisionLossException]
    = "Perte significative de précision détectée.";
$error['DE'][PrecisionLossException]
    = "Bedeutender Präzision Verlust ermittelte.";

define('MatrixSPDException', -6);
$error['EN'][MatrixSPDException]
