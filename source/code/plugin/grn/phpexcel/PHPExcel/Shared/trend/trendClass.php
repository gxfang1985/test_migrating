...
class trendClass
{
    ...
    public static function calculate(
        ...
        if ($nX == 0) {
            ...
            trigger_error("trend(): Number of elements in coordinate arrays do not match.",
                E_USER_ERROR);
        }
        ...
        switch ($trendType) {
            ...
            case self::TREND_POWER :
                if ( ! isset(self::$_trendCache[$key])) {
                    $className = 'PHPExcel_' . $trendType
                                 . '_Best_Fit';
                    self::$_trendCache[$key] = new $className($yValues,
                        $xValues, $const);
                }
            ...
            case self::TREND_POLYNOMIAL_6    :
                if ( ! isset(self::$_trendCache[$key])) {
                    ...
                    self::$_trendCache[$key]
                        = new PHPExcel_Polynomial_Best_Fit($order, $yValues,
                        $xValues, $const);
                }
            ...
            case self::TREND_BEST_FIT_NO_POLY    :
                ...
                foreach (self::$_trendTypes as $trendMethod) {
                    $className = 'PHPExcel_' . $trendMethod
                                 . 'BestFit';
                    $bestFit[$trendMethod] = new $className($yValues, $xValues,
                        $const);
                ...
                if ($trendType != self::TREND_BEST_FIT_NO_POLY) {
                    foreach (self::$_trendTypePolyOrders as $trendMethod) {
                        ...
                        $bestFit[$trendMethod]
                            = new PHPExcel_Polynomial_Best_Fit($order,
