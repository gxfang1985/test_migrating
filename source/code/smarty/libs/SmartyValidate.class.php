...
class SmartyValidate {
     ...
     * @param string $form the name of the form being validated
     */
    public static function is_registered_form($form = 'default') {
     ...
     * @param string $form the name of the form being validated
     */
    public static function is_valid(&$formvars, $form = 'default') {
     ...
     * @param string $func_name the function being registered
     */
    public static function register_criteria($name, $func_name, $form = 'default') {
     ...
     * @param string $func_name the function being registered
     */
    public static function register_transform($name, $func_name, $form = 'default') {
     ...
     */
    public static function is_registered_criteria($name, $form = 'default') {
        if(!SmartyValidate::is_registered_form($form)) {
     ...
     * @param string $var the value being booleanized
     */
    public static function is_registered_transform($name, $form = 'default') {
        if(!SmartyValidate::is_registered_form($form)) {
     ...
     * @param string $func_name the function being registered
     */
    public static function _register_function($type, $name, $func_name, $form = 'default') {
        if(!SmartyValidate::is_registered_form($form)) {
    ...
    public static function _booleanize($var) {
        if( is_string( $var ) &&
            in_array(strtolower($var), array('true','on','yes','y')) )
            return true;
        return (bool)$var;
    }
