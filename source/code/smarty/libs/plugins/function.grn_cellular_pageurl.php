...
function smarty_function_grn_cellular_pageurl($params, &$smarty)
{
    $function_name = "grn_cellular_pageurl";
    ...
    $pageurl = grn_cellular_pageurl($page, $rest_params, $fragment, $postfix);
