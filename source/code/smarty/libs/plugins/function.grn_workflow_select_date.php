...
function smarty_function_grn_workflow_select_date($params, &$smarty)
{
...
//    $current_date = getdate();
    ...
    if ($popup_calendar) {
        ...
        $page_url .= 'prefix=' . htmlspecialchars($prefix) . '&form_name='
                     ...
                     . '&script_name=grn_workflow_select_date_init_date_select&script_name2=grn_workflow_select_date_display_calendar';
...
function _grn_select_date_write_year(
    ...
    if ($necessary || $show_wday) {
        $onchange_str
            = ' onChange="grn_workflow_select_date_init_day(this.form, \''
