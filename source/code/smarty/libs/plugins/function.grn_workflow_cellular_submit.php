...
function smarty_function_grn_workflow_cellular_submit($params, &$smarty)
{
    $function_name = "grn_workflow_cellular_submit";
    ...
    if ($accesskey >= 0 && $accesskey < 10) {
        ...
        $accesskey_icon
            = smarty_function_grn_workflow_cellular_pictogram([
            'key' => 'num' . $accesskey
        ], $smarty);
        $out .= " accesskey='" . htmlspecialchars($accesskey) . "' directkey='"
                . htmlspecialchars($accesskey) . "' value='" . $accesskey_icon
