 ...
 *
 *  記述例
 *  <pre>{grn_default_appname app_id="sample"}
 */
function smarty_function_grn_default_appname($params, &$smarty)
{
    $function_name = 'grn_default_appname';
    ...
    $name = $locator->getDefaultName($app_id, $locale);
