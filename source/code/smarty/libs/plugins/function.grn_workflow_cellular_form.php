 ...
 */
function smarty_function_grn_workflow_cellular_form($params, &$smarty)
{
    $function_name = "grn_workflow_cellular_form";
    ...
    $page = __grn_workflow_cellular_prepare_page($page, $params);
    ...
    $url = grn_workflow_cellular_remote_path($url);
