 ...
 */
function smarty_function_grn_workflow_cellular_pictogram($params, &$smarty)
{
    $function_name = "grn_workflow_cellular_pictogram";
    ...
    return cb_msg('grn.workflow.cellular.pictogram.' . $carrier, $key, $args);
}
