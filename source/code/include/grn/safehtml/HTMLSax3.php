...
class XML_HTMLSax3_StateParser
{
    ...
    function __construct($htmlsax)
    {
        ...
        $this->State[XML_HTMLSAX3_STATE_ESCAPE]
...
class XML_HTMLSax3_StateParser_Lt430 extends XML_HTMLSax3_StateParser
{
    ...
    function scanUntilCharacters($string)
    {
        ...
        while ($this->position < $this->length
               && strpos($string, $this->rawtext{$this->position}) === false) {
            $this->position++;
        }
...
class XML_HTMLSax3
{
    ...
    {
        $this->state_parser->handler_object_data
    ...
    {
        $this->state_parser->handler_object_element
            = $this->state_parser->handler_default;
    ...
    {
        $this->state_parser->handler_object_pi
            = $this->state_parser->handler_default;
    ...
    {
        $this->state_parser->handler_object_escape
            = $this->state_parser->handler_default;
    ...
    {
        $this->state_parser->handler_object_jasp
            = $this->state_parser->handler_default;
