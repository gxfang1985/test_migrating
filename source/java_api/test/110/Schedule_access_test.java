	...
	public static void main(String[] args) {
        ...
        try {
            ...
            try {
                ...
                String addevent = cp.putScheduleAdd(Integer.parseInt(eventKind),// 予定区分
            ...
            try {
                // Garoonへスケジュール登録情報を送信
                String deladdevent = cp.putScheduleAdd(Integer.parseInt(eventKind),// 予定区分
                                                    titleMenu,                  // 予定タイトルメニュー
                                                    title,                      // 予定タイトル
                                                    eventPrivate,               // 公開/非公開
                                                    detail,                     // 予定メモ
...
*/                if(followId == null){
                    ...
                    String delfollowId = cp.putScheduleFollowDelete(Long.parseLong("1016"),  // ガルーン２のスケジュールフォローID
                                                                   registrant);          // 削除者
