    ...
    */
    public static void main(String[] args) 
    {
        ...
        for ( int i = 0; i < args.length; i++ ) {
            ...
            else if ( args[i].equals("-tm") ) {     // 予定タイトルメニュー
                if ( i == (args.length - 1) ) {
        ...
        try {
            ...
            if ( !"0".equals(eventKind) &&  !"1".equals(eventKind) ) {       // 予定区分(0 or 1)
                do {
            ...
            event = scheduleLink.putScheduleAdd(Integer.parseInt(eventKind),// 予定区分
