...
public class CmdCabinetUpload {
    ...
    {
        System.err.println("Usage: java CmdCabinetUpload [OPTIONS]");
        System.err.println("");
        ...
        System.err.println("       -id  FILEID      The file id that you want to upload.");
        ...
        System.err.println("       -c   COMMENT     The comment of file to upload.");
    }
    ...
    public static void main( String[] args )
    {
        ...
        for ( int i = 0; i < args.length; i++ )    {
            if ( args[i].equals("-h") ) {                   // Print this message and exit.
                ...
                if ( i == (args.length - 1) ) {
                    System.err.println("missing file to upload after -f.");
                    System.err.println("");
                    usage();
                    return;
                }
            ...
            else if ( args[i].equals("-c") ) {                // 更新コメント
                if ( i == (args.length - 1) ) {
                    System.err.println("missing comment of file after -c.");
                    System.err.println();
                    usage();
                    return;
                }
