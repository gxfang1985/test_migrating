...
public class CmdOrganizationUserImport
{
    /**
     * ガイダンスを表示します。<BR>
     *
    ...
    {
        System.err.println("Usage: java CmdOrganizationUserImport [OPTIONS]");
        System.err.println("");
        ...
        System.err.println("       -f   FILE          The csv file to read.");
    ...
    public static void main( String[] args )
    {
        ...
        try {
            ...
            // Garoonへデータ送信
            grnLink.importOrganizationUser( filepath,        // ファイルパス
                                            skip,            // 先頭行の有無
                                            sjisEncode );    // エンコード指定(true:Shif_JIS,false:UTF-8)
            
            System.out.println("The upload of the csv file was executed.(" + filepath + ")");
        }
