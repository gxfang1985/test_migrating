grn.base.namespace("grn.component.member_select_search_info");
(function($) {
    "use strict";
    $(function() {
        grn.component.member_select_search_info = (function() {
            ...
            if (typeof searchBtnPosition === 'undefined') {
                searchBtnPosition = {};
                searchBtnPosition.left = searchTargetIconPos.left;
            }
        ...
        var thePopup = grn.component.member_select_search_info;
