...
function grn_workflow_select_date_init_date_select( form_name, year, month, day, prefix)
{
    ...
    var last_day = grn_workflow_select_date_get_last_day(year, month);
    var offset = 0;
    ...
    for(i = 0 ; i < last_day ; i ++)
    {
        ...
        {
            grn_workflow_select_date_add_option(day_options, day_option);
        }
        ...
        {
            if(grn_workflow_select_date_check_holiday(g_arrayHolidays, year, month, day_option))
            {
        ...
        {
            if(grn_workflow_select_date_check_workday(g_arrayWorkdays, year, month, day_option))
            {
                day_options[opt_idx].className = "";
            }
        }
...
function grn_workflow_open_iframe (form_name, prefix, frame_src)
{
    ...
    if(!select_year.disabled)
    {
        ...
        grn_workflow_select_date_display_calendar(id);
        openIds = new Array(id);
    }
}

function grn_workflow_select_date_init_day(form, prefix, no_year, no_wday, src)
{
    ...
    for(i = 0 ; i < last_day ; i ++)
    {
        ...
        {
            grn_workflow_select_date_add_option(options, day);
        }
        ...
        if(g_arrayHolidays != null && g_arrayHolidays.length > 0)
        {
            if(grn_workflow_select_date_check_holiday(g_arrayHolidays, year, month, day))
            {
        ...
        if(g_arrayWorkdays != null && g_arrayWorkdays.length > 0)
        {
            if(grn_workflow_select_date_check_workday(g_arrayWorkdays, year, month, day))
            {
                options[opt_idx].className = "";
            }
        }
...
function grn_workflow_select_date_get_last_day(year, month)
{
    if(month != 2)
    {
...
function grn_workflow_select_date_add_option(options, day)
{
...
function grn_workflow_select_date_display_calendar(id)
{
...
function grn_workflow_select_date_check_holiday(holidays, year, month, day)
{
...
function grn_workflow_select_date_check_workday(workdays, year, month, day)
{
