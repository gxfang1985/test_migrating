...
function __grn_report_create_search_common(id)
{
...
function __grn_report_create_search_item(id, type)
{
...
function grn_report_add_search_item()
{
    ++idNum;
    ...
    div.id = 'fdiv' + idNum;
    div.innerHTML = __grn_report_create_search_common(idNum);
    ...
    grn_report_check_search_delete(delete_count);
    
    return true;
}

function grn_report_delete_search_item(id)
{
...
function grn_report_delete_search_item_all()
{
    var fbox = document.getElementById('fbox');
    fbox.innerHTML = '';
...
function grn_report_change_search_item(id, select)
{
    var fspan = document.getElementById('fspan' + id);
    fspan.innerHTML = __grn_report_create_search_item(id, select.selectedIndex);
    return true;
}

function grn_report_check_search_delete(delete_count)
{
