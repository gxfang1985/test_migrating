    ...
    return function (editor) {
      ...
      function showDialog(imageList) {
        ...
        function updateStyle() {
          ...
          css['border'] = Utils.addPixelSuffix(data.border);
          if (css['border']) {
          ...
          css['vertical-align'] = "";
          if (data.alignment) {
            if (data.alignment == "left" || data.alignment == "right") {
              css['float'] = data.alignment;
            }
            else {
              css['vertical-align'] = data.alignment;
            }
          }
        ...
        function updateVSpaceHSpaceBorder() {
          ...
          //Move border
          if (css['border']) {
            win.find('#border').value(Utils.removePixelSuffix(css['border']));
          }
        ...
        if (imageDimensions) {
          generalFormItems.push({
            ...
            items: [
              ...
              { name: 'constrain', type: 'checkbox', checked: false, visible: false, text: 'Constrain proportions' }
            ]
          });
        }
        ...
        if (editor.settings.image_advtab || editor.settings.images_upload_url) {
          ...
          if (editor.settings.image_advtab) {
            ...
            if (imgElm) {
              ...
              if (imgElm.style.float != "" || imgElm.style['vertical-align'] != "") {
                  data.alignment = imgElm.style.float || imgElm.style['vertical-align'];
              }
            ...
            body.push({
              ...
              items: [
                ...
                },
                {
                  ...
                  label: 'Alignment',
                  values: [
                    {text: tinymce.i18n.data[langCode].grn_common.not_set, value: ""},
                    {text: tinymce.i18n.data[langCode].grn_common.baseline, value: "baseline"},
                    {text: tinymce.i18n.data[langCode].grn_common.top, value: "top"},
                    {text: tinymce.i18n.data[langCode].grn_common.middle, value: "middle"},
                    {text: tinymce.i18n.data[langCode].grn_common.bottom, value: "bottom"},
                    {text: tinymce.i18n.data[langCode].grn_common.text_top, value: "text-top"},
                    {text: tinymce.i18n.data[langCode].grn_common.text_bottom, value: "text-bottom"},
                    {text: tinymce.i18n.data[langCode].grn_common.left, value: "left"},
                    {text: tinymce.i18n.data[langCode].grn_common.right, value: "right"}
                  ],
          ...
          win = editor.windowManager.open({
            ...
            body: body,
            buttons: [{
              text: tinymce.i18n.data[langCode].grn_common.image_ok,
              subtype: 'primary',
              onclick: function () {
                onSubmitForm();
